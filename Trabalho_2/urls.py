...
urlpatterns = [
    ...
    path('purplese/login/', LoginView.as_view(template_name='registros/login.html'),name='sec-login'),
    path('purplese/logout/',LogoutView.as_view(next_page=reverse_lazy('purplese/')),name='sec-logout'),
    path('purplese/senhaTrocada/',PasswordChangeView.as_view(template_name='registros/password_change_done.html'),name='sec-passwordDone'),
    path('purplese/trocaSenha/',PasswordChangeView.as_view(template_name='registros/password_change_form.html',success_url=reverse_lazy('sec-passwordDone')),name='sec-passwordchange'),
    path('purplese/terminaRegistro/<int:pk>/',UpdateView.as_view(template_name='registros/user_form.html',success_url=reverse_lazy('sec-paginaSecreta',
 ...
 path('purplese/password_reset_done/', PasswordResetDoneView.as_view(template_name='registros/password_reset_done.html',
